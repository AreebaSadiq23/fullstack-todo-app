...
def main():
    ...
    parser_add.add_argument("--title", type=str, required=True, help="The title of the task")
    parser_add.add_argument("--description", type=str, default="", help="The description of the task")
    ...
    parser_update.add_argument("--description", type=str, help="The new description of the task")
    ...
    parser_incomplete.add_argument("id", type=int, help="The ID of the task to mark as incomplete")
    ...
    try:
        if args.command == "add":
            ...
            if args.title is None and args.description is None:
                print("Error: You must provide either --title or --description to update.", file=sys.stderr)
                sys.exit(1)
